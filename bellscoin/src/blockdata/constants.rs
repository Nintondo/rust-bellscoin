...
/// How many satoshis are in "one bellscoin".
...
pub const DIFFCHANGE_TIMESPAN: u32 = 4 * 60 * 60;
...
pub const MAX_MONEY: u64 = 500_000_000 * COIN_VALUE;
...
mod test {
    ...
    fn bitcoin_genesis_full_block() {
        let gen = genesis_block(Network::Bellscoin);
    ...
    chain_hash_genesis_block! {
        mainnet_chain_hash_genesis_block, Network::Bellscoin;
    ...
    fn mainnet_chain_hash_test_vector() {
        let got = ChainHash::using_genesis_block(Network::Bellscoin).to_string();
