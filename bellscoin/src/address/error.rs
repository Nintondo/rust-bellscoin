...
impl From<witness_version::TryFromError> for Error {
    fn from(e: witness_version::TryFromError) -> Error {
        Error::WitnessVersion(e)
    }
}

impl From<witness_program::Error> for Error {
    fn from(e: witness_program::Error) -> Error {
        Error::WitnessProgram(e)
    }
}

/// Address type is either invalid or not supported in rust-bellscoin.
#[derive(Debug, Clone, PartialEq, Eq)]
#[non_exhaustive]
